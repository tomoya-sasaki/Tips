...
* Use [for intel](https://cloud.r-project.org/bin/macosx/base/) or [for Apple silicon](https://cran.r-project.org/bin/macosx/big-sur-arm64/base/) to find binaries of R builds for macOS
